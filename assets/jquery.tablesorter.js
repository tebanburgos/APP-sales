...
;( function( $ ) {
	...
	var ts = $.tablesorter = {
		...
		defaults : {
			...
			// *** appearance
			theme            : 'dropbox',  // adds tablesorter-{theme} to the table for styling
		...
		*/
		...
		formatFloat : function( str, table ) {
			...
			if ( usFormat ) {
				...
				// LA LÍNEA DE ABAJO ES PARTE DEL CÓGIDO ORIGINAL Y FUE COMENTADO PARA PODER 'FORMATEAR' LOS CAMPOS DE TIPO NÚMERO
